        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PostalCodePrefix = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockQuantity = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliverySlotId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    DeliveryPostalCode = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "DeliverySlots",
                columns: new[] { "DeliveryDate", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_DeliverySlots_DeliveryDate_StartTime_EndTime",
                table: "DeliverySlots",
                columns: new[] { "DeliveryDate", "StartTime", "EndTime" },
                unique: true);
