...
public interface IOrderService
{
    ...
    Task<OrderDto> PlaceOrderAsync(int userId, int deliverySlotId, string postalCodePrefix, string deliveryAddress, string deliveryPostalCode, string? notes, IEnumerable<(int ProductId, decimal Quantity)> items, CancellationToken ct);
